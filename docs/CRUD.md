...
**Todas as rotas POST/PUT/PATCH/DELETE** no SimpleBlog são protegidas por **CSRF (Cross-Site Request Forgery)**.
...
- [ ] SimpleBlog clonado e funcionando
...
- SimpleBlog tem middleware CSRF ativo que valida TODAS requisições
